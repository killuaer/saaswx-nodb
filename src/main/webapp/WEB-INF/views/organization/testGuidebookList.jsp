		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">检测指南内容编辑</h4>
				</div>
				<!-- ROW 2 -->
					<div class="row">
						<div class="col-md-12">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="page-header">
							...
							<!-- BREADCRUMBS -->
							<ul class="breadcrumb">
								<li><i class="fa fa-home"></i> <a href="index.html">微信平台</a>
								</li>
								<li><a href="#">检测指南</a></li>
							</ul>
						</div>
						...
						function() {
							$('#datatable1')
									.DataTable(
											{
												ajax : {
													url : '${ctx}/organizationInfo/listTestGuideBook',
													dataSrc : ''
												},
												columns : [
														{
