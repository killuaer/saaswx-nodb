...
<link rel="stylesheet" type="text/css"
	href="${ctx}/assets1/css/cloud-admin.css">
<link rel="stylesheet" type="text/css"
	href="${ctx}/assets1/css/themes/nature.css" id="skin-switcher">
<link rel="stylesheet" type="text/css"
	href="${ctx}/assets1/css/responsive.css">

<link href="${ctx}/assets1/font-awesome/css/font-awesome.min.css"
	rel="stylesheet">
<!-- DATE RANGE PICKER -->
<link rel="stylesheet" type="text/css"
	href="${ctx}/assets1/js/bootstrap-daterangepicker/daterangepicker-bs3.css" />
<!-- FONTS -->

<!-- JQUERY UI-->
<link rel="stylesheet" type="text/css"
	href="${ctx}/assets1/js/jquery-ui-1.10.3.custom/css/custom-theme/jquery-ui-1.10.3.custom.min.css" />
<!-- DATE RANGE PICKER -->
<link rel="stylesheet" type="text/css"
	href="${ctx}/assets1/js/bootstrap-daterangepicker/daterangepicker-bs3.css" />
<!-- DATA TABLES -->
<link rel="stylesheet" type="text/css"
	href="${ctx}/assets1/js/datatables/media/css/jquery.dataTables.min.css" />
<link rel="stylesheet" type="text/css"
	href="${ctx}/assets1/js/datatables/media/assets/css/datatables.min.css" />
<link rel="stylesheet" type="text/css"
	href="${ctx}/assets1/js/datatables/extras/TableTools/media/css/TableTools.min.css" />
...
<body>
	...
	<header class="navbar clearfix navbar-fixed-top" id="header">
		<div class="container">
			<div class="navbar-brand">
				<!-- COMPANY LOGO -->
				<a href="#"> <img src="${ctx}/assets1/img/logo/logo.png"
			...
			<ul class="nav navbar-nav pull-left hidden-xs" id="navbar-left">
				<li class="dropdown"><a href="#"
					...
					data-toggle="tooltip" title="Toggle Team View"> <i
						class="fa fa-users"></i> <span class="name">团队动态</span> <i
						class="fa fa-angle-down"></i>
				</a></li>
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown"> <i class="fa fa-cog"></i> <span
						class="name">换肤</span> <i class="fa fa-angle-down"></i>
				</a>
			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown" id="header-message"><a href="#"
					...
					<ul class="dropdown-menu inbox">
						...
						<li><a href="#"> <img
								src="${ctx}/assets1/img/avatars/avatar2.jpg" alt="" /> <span
						...
						<li><a href="#"> <img
								src="${ctx}/assets1/img/avatars/avatar1.jpg" alt="" /> <span
						...
						<li><a href="#"> <img
								src="${ctx}/assets1/img/avatars/avatar8.jpg" alt="" /> <span
				...
				<li class="dropdown user" id="header-user"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img alt=""
						src="${ctx}/assets1/img/avatars/avatar3.jpg" /> <span
			...
			<div id="teamslider">
				<ul class="team-list">
					<li class="current"><a href="javascript:void(0);"> <span
							class="image"> <img
								src="${ctx}/assets1/img/avatars/avatar3.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/assets1/img/avatars/avatar1.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/assets1/img/avatars/avatar2.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/assets1/img/avatars/avatar4.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/assets1/img/avatars/avatar5.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/assets1/img/avatars/avatar6.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/assets1/img/avatars/avatar7.jpg" alt="" />
					...
					<li><a href="javascript:void(0);"> <span class="image">
								<img src="${ctx}/assets1/img/avatars/avatar8.jpg" alt="" />
	...
	<section id="page">
		...
		<div id="sidebar" class="sidebar sidebar-fixed">
			<div class="sidebar-menu nav-collapse">
				...
				<!-- SIDEBAR MENU -->
				<ul>
					<li><a href="#" onclick="showRight('${ctx}/basic/WeChatUserInfoList')"> 
					    <i class="fa fa-bookmark-o fa-fw"></i> 
					       <span class="menu-text">微信帐号信息</span>
					   </a>
					</li>
					<li><a href="#" onclick="showRight('${ctx}/basic/WeChatUserInfoList')"> 
					    <i class="fa fa-bar-chart-o fa-fw"></i> 
					       <span class="menu-text">用户帐号信息</span>
					    </a>
					</li>
					<li><a href="#" onclick="showRight('${ctx}/report/jccoresampleList')"> 
					    <i class="fa fa-tachometer fa-fw"></i> 
					       <span class="menu-text">样 品 信 息</span>
						   <span class="selected"></span>
					    </a>
					</li>
					<li><a href="#" onclick="showRight('${ctx}/organizationInfo/recentNewsPage')">
					    <i class="fa fa-desktop fa-fw"></i> 
					       <span class="menu-text">最 新 动 态</span>
					    </a>
					</li>
					<li><a href="#" onclick="showRight('${ctx}/organizationInfo/contactUsPage')">
					     <i class="fa fa-envelope-o fa-fw"></i>
					       <span class="menu-text">联 系 我 们</span>
					     </a>
					</li>
					<li><a href="#" onclick="showRight('${ctx}/organizationInfo/chargesPage')"> 
					    <i class="fa fa-table fa-fw"></i> 
					       <span class="menu-text">收 费 标 准</span>
					    </a>
					</li>
					<li><a href="#" onclick="showRight('${ctx}/organizationInfo/testGuideBookPage')"> 
					     <i class="fa fa-pencil-square-o fa-fw"></i> 
					        <span class="menu-text">送 检 指 南</span>
					     </a>
					</li>
					<li><a href="#" onclick="showRight('${ctx}/organizationInfo/workFlowPage')"> 
					     <i class="fa fa-calendar fa-fw"></i> 
					        <span class="menu-text">办  事  流  程</span>
					     </a>
					</li>
					<li><a href="#" onclick="showRight('${ctx}/organizationInfo/jccoresampleList')">
					     <i class="fa fa-th-large fa-fw"></i>
							<span class="menu-text">人 员 管 理</span>
						</a>
					</li>
					<li><a href="#" onclick="showRight('${ctx}/organizationInfo/jccoresampleList')"> <i
							class="fa fa-map-marker fa-fw"></i> 
							<span class="menu-text">单 位 地 图</span>
					    </a>
					</li>
				</ul>
				<!-- /SIDEBAR MENU -->
		...
		<!-- /SIDEBAR -->
		<div id="main-content" >
			<div id="contenHtml" class="container"></div>
		</div>
	</section>
	<!--/PAGE -->
	<!-- JAVASCRIPTS -->
	...
	<!-- JQUERY -->
	<script src="${ctx}/assets1/js/jquery/jquery-2.0.3.min.js"></script>
	<!-- JQUERY UI-->
	<script
		src="${ctx}/assets1/js/jquery-ui-1.10.3.custom/js/jquery-ui-1.10.3.custom.min.js"></script>
	<!-- BOOTSTRAP -->
	<script src="${ctx}/assets1/bootstrap-dist/js/bootstrap.min.js"></script>


	<!-- DATE RANGE PICKER -->
	<script src="${ctx}/assets1/js/bootstrap-daterangepicker/moment.min.js"></script>

	<script
		src="${ctx}/assets1/js/bootstrap-daterangepicker/daterangepicker.min.js"></script>
	<!-- SLIMSCROLL -->
	<script type="text/javascript"
		src="${ctx}/assets1/js/jQuery-slimScroll-1.3.0/jquery.slimscroll.min.js"></script>

	<script type="text/javascript"
		src="${ctx}/assets1/js/jQuery-slimScroll-1.3.0/slimScrollHorizontal.min.js"></script>
	<!-- COOKIE -->
	<script type="text/javascript"
		src="${ctx}/assets1/js/jQuery-Cookie/jquery.cookie.min.js"></script>

	<!-- BLOCK UI -->
	<script type="text/javascript"
		src="${ctx}/assets1/js/jQuery-BlockUI/jquery.blockUI.min.js"></script>
	<!-- DATA TABLES -->
	<script type="text/javascript"
		src="${ctx}/assets1/js/datatables/media/js/jquery.dataTables.min.js"></script>
	<script type="text/javascript"
		src="${ctx}/assets1/js/datatables/media/assets/js/datatables.min.js"></script>
	<script type="text/javascript"
		src="${ctx}/assets1/js/datatables/extras/TableTools/media/js/TableTools.min.js"></script>
	<script type="text/javascript"
		src="${ctx}/assets1/js/datatables/extras/TableTools/media/js/ZeroClipboard.min.js"></script>
	...
	<script>
		...
		function showRight(url) {
			$("#contenHtml", window.parent.document).load(
